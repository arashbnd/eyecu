...
# adding images of homeowners to recognize
...
while True:
    ...
    for (top, right, bottom, left), name in zip(face_locations, face_names):
        ...
        cv2.rectangle(small_frame, (left, bottom + 10), (right, bottom), (0, 0, 255), cv2.FILLED)
        font = cv2.FONT_HERSHEY_DUPLEX
        cv2.putText(small_frame, name, (left + 1, bottom + 6), font, 0.35, (255, 255, 255), 1)
